...
if __name__ == '__main__':
    ...
    chrome_driver, platform = denv.set_driver_path()
    os.environ["webdriver.chrome.driver"] = chrome_driver
    driver = webdriver.Chrome(chrome_driver)
    driver.get('')
    print(dir(driver))
    print(help(driver.get_screenshot_as_png))
